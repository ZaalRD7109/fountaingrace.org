...
const jsonLd = [
  ...
  },
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: "What does John 10:27 say about hearing God's voice?",
        acceptedAnswer: {
          '@type': 'Answer',
          text: "John 10:27 in the KJV says, 'My sheep hear my voice, and I know them, and they follow me.' This verse makes clear that hearing God is not a gift reserved for a select few prophets - it is the normal experience of every believer who belongs to Jesus. The relationship itself carries the ability to hear.",
        },
      },
      {
        '@type': 'Question',
        name: "Why do I feel like I can't hear God speaking to me anymore?",
        acceptedAnswer: {
          '@type': 'Answer',
          text: "Spiritual static builds up through neglecting the Word, allowing manipulation or hype to replace genuine encounter, and letting wrong motives creep into the prophetic. Pastor Ricardo teaches that God never stopped speaking - the problem is almost always on the receiving end, not the sending end. Returning to scripture, prayer and honest journaling are the first steps to clearing that static.",
        },
      },
      {
        '@type': 'Question',
        name: "How does God speak to believers today according to the Bible?",
        acceptedAnswer: {
          '@type': 'Answer',
          text: "According to this sermon, God speaks primarily through scripture, through His Holy Spirit as an inner unction or impression to say or do something, and through creation. Romans 1:20 affirms that creation itself communicates God's invisible qualities. The key discipline is learning to recognise and respond to each of these channels consistently.",
        },
      },
      {
        '@type': 'Question',
        name: "What is the difference between true prophecy and prophetic hype?",
        acceptedAnswer: {
          '@type': 'Answer',
          text: "True prophecy keeps Christ at the centre, is delivered in purity and humility, and produces lasting fruit in the life of the hearer. Prophetic hype spikes emotions in the moment but fades quickly, often leaving people more confused or manipulated than built up. Pastor Ricardo teaches that genuine prophetic ministry is accountable, rooted in love and never used to control or sell outcomes to people.",
        },
      }
    ],
  },
...
const sd = {
  ...
  "sections": [
    {
      "heading": "Why Every Believer Has the Right to Hear God's Voice",
      "paragraphs": [
    ...
    {
      "heading": "How God Speaks - Three Channels You Already Have Access To",
      "paragraphs": [
    ...
    {
      "heading": "The Four-Week Prophetic Reset Framework",
      "paragraphs": [
    ...
    {
      "heading": "Journaling, Disciplines and the Danger of Letting Words Go Unrecorded",
      "paragraphs": [
  ...
  "faqs": [
    {
      "q": "What does John 10:27 say about hearing God's voice?",
      "a": "John 10:27 in the KJV says, 'My sheep hear my voice, and I know them, and they follow me.' This verse makes clear that hearing God is not a gift reserved for a select few prophets - it is the normal experience of every believer who belongs to Jesus. The relationship itself carries the ability to hear."
    },
    {
      "q": "Why do I feel like I can't hear God speaking to me anymore?",
      "a": "Spiritual static builds up through neglecting the Word, allowing manipulation or hype to replace genuine encounter, and letting wrong motives creep into the prophetic. Pastor Ricardo teaches that God never stopped speaking - the problem is almost always on the receiving end, not the sending end. Returning to scripture, prayer and honest journaling are the first steps to clearing that static."
    },
    {
      "q": "How does God speak to believers today according to the Bible?",
      "a": "According to this sermon, God speaks primarily through scripture, through His Holy Spirit as an inner unction or impression to say or do something, and through creation. Romans 1:20 affirms that creation itself communicates God's invisible qualities. The key discipline is learning to recognise and respond to each of these channels consistently."
    },
    {
      "q": "What is the difference between true prophecy and prophetic hype?",
      "a": "True prophecy keeps Christ at the centre, is delivered in purity and humility, and produces lasting fruit in the life of the hearer. Prophetic hype spikes emotions in the moment but fades quickly, often leaving people more confused or manipulated than built up. Pastor Ricardo teaches that genuine prophetic ministry is accountable, rooted in love and never used to control or sell outcomes to people."
    }
  ],
  "steps": [
