...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Most of us feel unseen. What if your community was built to catch you before you fall?",
    type: 'article',
    images: [{ url: "https://img.youtube.com/vi/-W_gmscl1sw/maxresdefault.jpg", width: 1280, height: 720, alt: "The Person Who Notices When You Disappear - Fountain of Grace International" }],
    url: "https://www.fountaingrace.org/sermons/the-person-who-notices-when-you-disappear",
  },
}
...
const jsonLd = [
  {
    ...
    "@type": "Article",
    "headline": "The Person Who Notices When You Disappear",
    "description": "Discover why most people feel invisible in their own communities and how real accountability-built on notice, honesty, and follow-up-transforms isolation into belonging.",
    "author": {
      "@type": "Person",
    ...
    "datePublished": "2025-02-21T12:00:00+02:00",
    "url": "https://www.fountaingrace.org/sermons/the-person-who-notices-when-you-disappear"
  },
  {
    "@context": "https://schema.org",
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "The Person Who Notices When You Disappear",
        "item": "https://www.fountaingrace.org/sermons/the-person-who-notices-when-you-disappear"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "@type": "VideoObject",
    "name": "The Person Who Notices When You Disappear",
    "description": "The Person Who Notices When You Disappear",
    "thumbnailUrl": "https://img.youtube.com/vi/-W_gmscl1sw/maxresdefault.jpg",
    "uploadDate": "2025-02-21T12:00:00+02:00",
    "embedUrl": "https://www.youtube.com/embed/-W_gmscl1sw",
    "url": "https://www.fountaingrace.org/sermons/the-person-who-notices-when-you-disappear",
    "author": {
      "@type": "Person",
      "name": "Pastor Ricardo Zaal"
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"Feeling invisible as life keeps moving around you?"}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="-W_gmscl1sw" data-title={"The Person Who Notices When You Disappear"} dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/-W_gmscl1sw.webp" alt="" width="800" height="450" decoding="async" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
            ...
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"You hide your struggles from everyone"}</li>
                <li className="leading-relaxed">{"You're exhausted from doing it all alone"}</li>
                <li className="leading-relaxed">{"You feel guilty when others suffer"}</li>
                <li className="leading-relaxed">{"You want to stop feeling lonely"}</li>
              </ul>
            </div>
        ...
        <section className="bg-white py-14 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="list-decimal list-inside space-y-3 text-[#555] leading-relaxed mb-6">
              <li><strong>{"Accountability Requires Vulnerability First"}</strong> {" "}{"You cannot hold others accountable without first being honest with yourself and open to feedback about your own life. Pastor Ricardo models this by admitting when he failed to delegate, when he felt like giving up, and when he was too focused on his own problems to see others' needs. Accountability doesn't start with judgment of others. It starts with a mirror held up to your own heart. When you admit your limitations and ask for help, you give others permission to do the same. This is the foundation of real community."}</li>
        ...
        <section className="bg-gray-50 py-12 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"What do I do if I'm afraid of losing a friendship by holding someone accountable?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Pastor Ricardo says that speaking truth in love is one of the most loving things you can do. The key is how you approach it: ask questions before assuming, acknowledge that you might not have the whole story, and focus on their growth not their failure. Pray before you speak. If the relationship is real, honesty will strengthen it, not destroy it. If it does fall apart, that reveals it wasn't built on solid ground anyway. A true friend wants you to speak up when they're heading in the wrong direction."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"How do I find an accountability partner if I don't have anyone I trust that deeply?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Start small. You don't need to find someone who has it all figured out. Find someone willing to be honest with you and to receive your honesty. This might be a coworker, a family member, or someone from your community. Begin with lower stakes conversations. Share a smaller struggle or ask for feedback on something you're working on. As you practice vulnerability and see that person handle it with care, trust grows. Real accountability partnerships are built over time, not found fully formed."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"What if someone I'm trying to hold accountable gets defensive or angry?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"That's a signal to pause. You may have approached too quickly without building enough trust first. Or you may have assumed too much without asking questions. Go back to listening. Ask what they heard when you spoke. Apologize if you came across harsh. Remind them you care about them and that's why you said something. Sometimes people need time to process. The goal isn't to win the argument. It's to preserve the relationship while speaking truth. If they consistently reject every attempt at accountability, you may need to accept that you can't force change. What you can do is remain available and consistent."}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/the-person-who-notices-when-you-disappear%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
