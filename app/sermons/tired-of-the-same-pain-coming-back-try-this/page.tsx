...
const jsonLd = [
  {
    ...
    "datePublished": "2025-12-14T12:00:00+02:00",
    "url": "https://www.fountaingrace.org/sermons/tired-of-the-same-pain-coming-back-try-this"
  },
  {
    "@context": "https://schema.org",
      ...
      <article>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p data-byline className="text-white text-sm mt-3">Preached by Pastor Ricardo Zaal, Fountain of Grace International, Pretoria North &middot; 14 December 2025</p>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"Why does nothing change even after all your trying?"}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="_fxcjo2raRQ" data-title="Tired of the Same Pain Coming Back? Try This" dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/_fxcjo2raRQ.webp" alt="" width="400" height="225" decoding="async" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
            <p className="text-[#555] text-sm mt-4 mb-2">Prefer reading? The full sermon notes are below.</p>
            <div className="mt-4">
              <p className="text-[#1a1a1a] font-semibold text-sm mb-2">Jump to a moment in the message:</p>
              <div className="flex flex-col gap-2">
                <button type="button" data-start="0" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">0:00</span>{"Setting expectations"}</button>
                <button type="button" data-start="46" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">0:46</span>{"This message isn't for everyone"}</button>
                <button type="button" data-start="131" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">2:11</span>{"When money stops moving"}</button>
                <button type="button" data-start="221" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">3:41</span>{"Prayers that shift things"}</button>
                <button type="button" data-start="837" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">13:57</span>{"Know your real enemy"}</button>
                <button type="button" data-start="1237" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">20:37</span>{"Earth can hear you"}</button>
                <button type="button" data-start="2021" className="sermon-chapter text-left w-full bg-[#f7f7f7] hover:bg-[#f0fafa] border border-gray-200 rounded-lg px-4 py-3 text-[#333] transition-colors"><span className="text-[#006b6b] font-semibold mr-2">33:41</span>{"Earth as a weapon"}</button>
              </div>
            </div>
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"You feel like you're repeating mistakes"}</li>
                <li className="leading-relaxed">{"You sense family pain never leaves"}</li>
                <li className="leading-relaxed">{"You doubt your efforts matter at all"}</li>
                <li className="leading-relaxed">{"You keep facing the same dead ends"}</li>
              </ul>
            </div>
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/tired-of-the-same-pain-coming-back-try-this%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
