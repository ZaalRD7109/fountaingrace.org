...
export const metadata: Metadata = {
  ...
  description: "Exhaustion that sleep can't fix. Learn what's really stealing your rest and how to actually switch off.",
  robots: 'index, follow',
  alternates: { canonical: "https://www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep" },
  openGraph: {
    title: "Your Mind Won't Stop Working Even After 8 Hours of Sleep",
    description: "Exhaustion that sleep can't fix. Learn what's really stealing your rest and how to actually switch off.",
    type: 'article',
    images: [{ url: "https://img.youtube.com/vi/QpTIjLn3ItQ/maxresdefault.jpg", width: 1280, height: 720, alt: "Your Mind Won't Stop Working Even After 8 Hours of Sleep - Fountain of Grace International" }],
    url: "https://www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep",
  },
}
...
const jsonLd = [
  {
    ...
    "@type": "Article",
    "headline": "Your Mind Won't Stop Working Even After 8 Hours of Sleep",
    "description": "Stop carrying storms that aren't yours and learn why exhaustion persists even after sleep-the real problem is overload, not circumstances.",
    "author": {
      "@type": "Person",
    ...
    "datePublished": "2026-06-28T12:00:00+02:00",
    "url": "https://www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep"
  },
  {
    "@context": "https://schema.org",
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Your Mind Won't Stop Working Even After 8 Hours of Sleep",
        "item": "https://www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "@type": "VideoObject",
    "name": "Your Mind Won't Stop Working Even After 8 Hours of Sleep",
    "description": "Your Mind Won't Stop Working Even After 8 Hours of Sleep",
    "thumbnailUrl": "https://img.youtube.com/vi/QpTIjLn3ItQ/maxresdefault.jpg",
    "uploadDate": "2026-06-28T12:00:00+02:00",
    "embedUrl": "https://www.youtube.com/embed/QpTIjLn3ItQ",
    "url": "https://www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep",
    "author": {
      "@type": "Person",
      "name": "Pastor Ricardo Zaal"
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"You feel stuck carrying everyone else's problems while your own life falls apart"}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="QpTIjLn3ItQ" data-title={"Your Mind Won't Stop Working Even After 8 Hours of Sleep"} dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/QpTIjLn3ItQ.webp" alt="" width="400" height="225" decoding="async" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
            ...
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"You sleep 8 hours and still feel exhausted"}</li>
                <li className="leading-relaxed">{"You carry everyone else's stress as your own"}</li>
                <li className="leading-relaxed">{"You lie awake worrying about things you can't control"}</li>
                <li className="leading-relaxed">{"You've stopped believing rest is actually possible"}</li>
              </ul>
            </div>
          </div>
        </section>
        <section className="bg-white py-14 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="list-decimal list-inside space-y-3 text-[#555] leading-relaxed mb-6">
              <li><strong>{"Not Every Storm Is Yours"}</strong> {" "}{"When you take on someone else's crisis, their financial failure, their relationship mess, their life choices as your responsibility, you are adding weight that will sink your boat. Caring about someone is not the same as drowning in their storm. You can love people and still set boundaries. You can pray for people and still refuse to carry the weight of their choices. God made you responsible for your own boat, not everyone else's."}</li>
        ...
        <section className="bg-gray-50 py-12 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"How do I stop carrying other people's problems if I care about them?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Caring about someone and drowning in their storm are two different things. You can love people deeply and still refuse to take on weight that is not yours to carry. In fact, when you carry someone else's storm, you often teach them that they don't have to learn to walk on their own. Set boundaries. Pray for them. Help where you can. But do not sink your own boat trying to save theirs. Jesus cared for his disciples but did not take their panic into himself."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"I sleep 8 hours but still feel exhausted. Is something wrong with me?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"No, something is wrong with what you are carrying to bed. Your mind is spinning with worries, other people's problems, and stress that belongs to God, not you. Sleep and rest are not the same thing. You can sleep and never rest. Real rest happens when your mind actually stops. Try this: before bed, do a breathing exercise. Breathe in for five counts, hold for five, exhale for eight. Do this several times until your mind quiets. Then ask yourself: what storm am I carrying that is not mine? Say it out loud: 'This is not my storm to carry.' Then actually release it. Your body will rest better when your mind lets go."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"What does it mean to speak peace to the storm instead of just praying about it?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Prayer without action is incomplete. Jesus rested first, then he rose and spoke to the storm with authority. When you speak to your circumstances, you are using your tongue like a rudder to steer your life. Instead of speaking how big your problem is or how impossible things look, you speak what you want to become true: peace, calm, breakthrough, provision. Your words have power. The same God who spoke creation into existence gave you the ability to speak. Use it to name what you want, not to rehearse what you fear."}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/your-mind-wont-stop-working-even-after-8-hours-of-sleep%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
