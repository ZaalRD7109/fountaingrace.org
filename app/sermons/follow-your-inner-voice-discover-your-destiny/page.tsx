...
const jsonLd = [
  {
    ...
    datePublished: '2026-02-24T12:00:00+02:00',
    url: 'https://www.fountaingrace.org/sermons/follow-your-inner-voice-discover-your-destiny',
  },
  {
    '@context': 'https://schema.org',
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"Feeling caught between your past and your future?"}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="4Trsd4Q-2fY" data-title="Follow Your Inner Voice - Discover Your Destiny" dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/4Trsd4Q-2fY.webp" alt="" width="800" height="450" fetchpriority="high" decoding="async" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
            ...
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"You feel an inner pull toward something new"}</li>
                <li className="leading-relaxed">{"You doubt your own inner voice often"}</li>
                <li className="leading-relaxed">{"Your past warnings still hold you back"}</li>
                <li className="leading-relaxed">{"You struggle with fear of taking risks"}</li>
              </ul>
            </div>
