...
const jsonLd = [
  {
    ...
    "@type": "Article",
    "headline": "The Real Reason You're Trapped in Debt (And How to Break Free)",
    "description": "Discover why the constant struggle for money and worth is rooted in an unpaid debt - and how one sacrifice paid it completely.",
    "author": {
      "@type": "Person",
    ...
    "datePublished": "2024-12-08T12:00:00+02:00",
    "url": "https://www.fountaingrace.org/sermons/the-real-reason-youre-trapped-in-debt-and-how-to-break-free"
  },
  {
    "@context": "https://schema.org",
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "The Real Reason You're Trapped in Debt (And How to Break Free)",
        "item": "https://www.fountaingrace.org/sermons/the-real-reason-youre-trapped-in-debt-and-how-to-break-free"
      }
    ]
  },
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Does this mean I should never plan financially or save money?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  },
  {
    ...
    "@type": "VideoObject",
    "name": "The Real Reason You're Trapped in Debt (And How to Break Free)",
    "description": "The Real Reason You're Trapped in Debt (And How to Break Free)",
    "thumbnailUrl": "https://img.youtube.com/vi/rfeuO89XSFY/maxresdefault.jpg",
    "uploadDate": "2024-12-08T12:00:00+02:00",
    "embedUrl": "https://www.youtube.com/embed/rfeuO89XSFY",
    "url": "https://www.fountaingrace.org/sermons/the-real-reason-youre-trapped-in-debt-and-how-to-break-free",
    "author": {
      "@type": "Person",
      "name": "Pastor Ricardo Zaal"
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"Feel trapped in cycles that never end?"}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <iframe src="https://www.youtube.com/embed/rfeuO89XSFY" title={"The Real Reason You're Trapped in Debt (And How to Break Free)"} className="absolute inset-0 w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
            ...
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"You feel overwhelmed by financial stress"}</li>
                <li className="leading-relaxed">{"You find yourself caught in survival mode"}</li>
                <li className="leading-relaxed">{"You struggle with believing in abundance"}</li>
                <li className="leading-relaxed">{"You feel undeserving of peace and acceptance"}</li>
              </ul>
            </div>
        ...
        <section className="bg-white py-14 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="list-decimal list-inside space-y-3 text-[#555] leading-relaxed mb-6">
              <li><strong>{"Your debt was canceled, not rescheduled"}</strong> {" "}{"The moment Jesus shed His blood on the cross, the legal charge against you - the red ink, the record of every failure - was completely erased, not forgiven later or conditionally. Colossians 2:13-14 makes this explicit: the handwriting that stood against you was nailed to the cross. This means you do not carry debt anymore. The weight you feel to perform, earn, and prove yourself is based on a debt that no longer exists. When you truly grasp this, the desperation that drives you to compete, to go into debt, to trample others, loses its power."}</li>
        ...
        <section className="bg-gray-50 py-12 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"Does this mean I should never plan financially or save money?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"No. Taking responsibility for what God has given you is stewardship, not desperation. The difference is the motivation and the method. Stewardship is using what you have wisely without fear or competition. Desperation is going into debt, working yourself to exhaustion, or compromising your values to get something you think you need. God's promise in Philippians 4:19 is that He meets your needs - but He often does this through your own work and wise choices, not through shortcuts or debt."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"What if I am already in debt? Does this mean I am condemned?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"No. The spiritual debt that separates you from God was canceled at the cross - that is the debt that matters eternally. Financial debt is real and has real consequences, but it is not the ultimate debt. If you are in financial debt now, the path forward is to stop the behavior that created it (like Black Friday mentality), receive God's provision for your daily needs, and work steadily to repay what you owe. Romans 13:8 says to owe no one anything except love - this is a call to move toward freedom, but it is a process, not a condemnation."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"If God provides for all my needs, why do I still feel anxious about money?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Belief and feeling are not the same. You may intellectually believe that God provides, but your emotions and habits may still be shaped by years of fear and scarcity. This is why the sermon emphasizes taking God at His word - standing on it and being intentional about it. As you consistently choose to trust God's promise instead of running toward desperation (debt, competition, Black Friday deals), your anxious feelings gradually shift. This is the renewing of your mind (Romans 12:2) - you are retraining yourself to live from abundance instead of fear."}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/the-real-reason-youre-trapped-in-debt-and-how-to-break-free%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
