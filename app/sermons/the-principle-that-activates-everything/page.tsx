...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [{ url: "https://img.youtube.com/vi/pM8THfQE3MU/maxresdefault.jpg", width: 1280, height: 720, alt: "The Principle That Activates Everything: Right Action - Fountain of Grace International" }],
...
const jsonLd = [
  {
    ...
    datePublished: '2026-03-15T12:00:00+02:00',
    url: 'https://www.fountaingrace.org/sermons/the-principle-that-activates-everything',
  },
  {
    '@context': 'https://schema.org',
        ...
        <section className="bg-[#000] py-8 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="pM8THfQE3MU" data-title="The Principle That Activates Everything: Right Action" dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/pM8THfQE3MU.webp" alt="" width="800" height="450" decoding="async" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
          </div>
        </section>
 ...
 - these messages are preached live every week at Fountain of Grace International, 323 B Danie Theron Street.
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/the-principle-that-activates-everything%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
