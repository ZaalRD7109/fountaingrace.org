...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Why your dad's presence matters more than his paycheck. What real fatherhood looks like and how to break the cycle.",
    type: 'article',
    images: [{ url: "https://img.youtube.com/vi/2LLBlGSHVnI/maxresdefault.jpg", width: 1280, height: 720, alt: "The Father Who Never Shows Up (And How It Breaks You) - Fountain of Grace International" }],
    url: "https://www.fountaingrace.org/sermons/the-father-who-never-shows-up-and-how-it-breaks-you",
  },
}
...
const jsonLd = [
  {
    ...
    "@type": "Article",
    "headline": "The Father Who Never Shows Up (And How It Breaks You)",
    "description": "True fatherhood is not about money-it is about closing the emotional distance first through active presence, sacrifice, and unconditional affirmation, the way God the Father runs toward us in shame and embarrassment before we even apologize.",
    "author": {
      "@type": "Person",
    ...
    "datePublished": "2026-06-21T12:00:00+02:00",
    "url": "https://www.fountaingrace.org/sermons/the-father-who-never-shows-up-and-how-it-breaks-you"
  },
  {
    "@context": "https://schema.org",
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "The Father Who Never Shows Up (And How It Breaks You)",
        "item": "https://www.fountaingrace.org/sermons/the-father-who-never-shows-up-and-how-it-breaks-you"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "@type": "VideoObject",
    "name": "The Father Who Never Shows Up (And How It Breaks You)",
    "description": "The Father Who Never Shows Up (And How It Breaks You)",
    "thumbnailUrl": "https://img.youtube.com/vi/2LLBlGSHVnI/maxresdefault.jpg",
    "uploadDate": "2026-06-21T12:00:00+02:00",
    "embedUrl": "https://www.youtube.com/embed/2LLBlGSHVnI",
    "url": "https://www.fountaingrace.org/sermons/the-father-who-never-shows-up-and-how-it-breaks-you",
    "author": {
      "@type": "Person",
      "name": "Pastor Ricardo Zaal"
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <p className="text-[#1a1a1a] text-lg font-semibold leading-snug mb-4">{"You needed your dad to show up. Not just send money."}</p>
            <div className="relative w-full rounded-xl overflow-hidden" style={{ paddingBottom: '56.25%' }}>
              <div className="sermon-embed absolute inset-0 w-full h-full" data-video="2LLBlGSHVnI" data-title={"The Father Who Never Shows Up (And How It Breaks You)"} dangerouslySetInnerHTML={{ __html: '<button type="button" class="sermon-play absolute inset-0 w-full h-full bg-black" aria-label="Play the sermon video"><img src="/sermon-thumbs/2LLBlGSHVnI.webp" alt="" width="400" height="225" decoding="async" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover"><span class="absolute inset-0 flex items-center justify-center"><span class="flex items-center justify-center w-16 h-16 rounded-full bg-[#006b6b]/90 shadow-lg"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8 h-8 ml-1 fill-white"><path d="M8 5v14l11-7z"/></svg></span></span></button>' }} />
            </div>
            ...
            <div className="bg-[#f0fafa] border border-[#cfeeee] rounded-xl p-5 mt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#555]">
                <li className="leading-relaxed">{"Your father provided but was never emotionally present"}</li>
                <li className="leading-relaxed">{"You are a dad stuck in the same absent pattern your father was"}</li>
                <li className="leading-relaxed">{"You feel shame about your situation and hide from your family"}</li>
                <li className="leading-relaxed">{"You need permission to prioritize presence over your pride"}</li>
              </ul>
            </div>
          </div>
        </section>
        <section className="bg-white py-14 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="list-decimal list-inside space-y-3 text-[#555] leading-relaxed mb-6">
              <li><strong>{"Presence Over Provision"}</strong> {" "}{"Money keeps a roof on the house but presence keeps a child from feeling abandoned. A father in action closes the distance first through physical presence, emotional availability, and sacrifice. He does not wait to be approached. He moves toward his children even when it costs him his dignity. Providing food and shelter is not enough. Your child needs to know you see them, you value them, and you will show up when it matters."}</li>
        ...
        <section className="bg-gray-50 py-12 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"I missed years with my kids. Is it too late to close the distance now?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"No. God saw you a great way off and ran toward you. He did not wait for you to be perfect or to have earned forgiveness. He closed the distance first. You can do the same. It will be hard. There will be awkwardness and pain. But starting now is infinitely better than waiting another year. Show up. Be honest about your past. Ask for forgiveness. Move toward your children even if they do not move toward you yet. This is fatherhood: closing the distance first, regardless of the cost to your pride."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"What if the mother is blocking me from seeing my kids?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"God sees you. He sees the silent suffering and the humiliation of a father who wants to be there but cannot. You are not a failure because of circumstances beyond your control. But do not use that as an excuse to give up. Find legal ways to be present. Write letters. Send gifts when you can. Pray. Ask God to turn her heart. And in the meantime, do not repeat this wound with your next generation. Be the father who closes the distance within whatever boundaries exist. God will honor your effort even when the system blocks your access."}</p>
              </div>
              <div>
                <h3 className="font-semibold text-[#1a1a1a] mb-2">{"I provide for my kids but I feel like I am not doing enough. Am I a bad father?"}</h3>
                <p className="text-[#555] leading-relaxed text-sm">{"Providing is not enough, but it is not nothing. If you are working hard to put food on the table and a roof over their heads, that matters. But your children need you, not just your money. They need to see your face. They need to hear your voice. They need to know that you see them and value them. Start small. Be present at one meal a week without your phone. Look at your child and tell them you are proud of them. Close the distance with your presence. You do not have to be perfect. You just have to move toward them."}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-12 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href={"https://wa.me/?text=I%20thought%20this%20message%20may%20encourage%20you%3A%20https%3A//www.fountaingrace.org/sermons/the-father-who-never-shows-up-and-how-it-breaks-you%3Futm_source%3Dwhatsapp"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg px-7 py-4 rounded-xl hover:bg-[#1ebe5d] transition-colors w-full sm:w-auto">
