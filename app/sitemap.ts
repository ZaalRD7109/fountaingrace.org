...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/sermons/the-principles-that-move-people-forward-faster`, lastModified: new Date('2025-03-08'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/sermons/why-youre-not-moving-forward-and-how-to-break-it`, lastModified: new Date('2025-03-01'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/sermons/what-if-someone-else-finishes-what-was-meant-for-you`, lastModified: new Date('2025-02-22'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/sermons/follow-your-inner-voice-discover-your-destiny`, lastModified: new Date('2025-02-24'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/sermons/be-a-doer-of-gods-word-not-just-a-hearer`, lastModified: new Date('2025-02-16'), changeFrequency: 'monthly', priority: 0.6 },
    // Legal
