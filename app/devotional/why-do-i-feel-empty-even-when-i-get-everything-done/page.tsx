...
export const metadata: Metadata = {
  title: "Why do I feel empty even when I get everything done?",
  description: "You wake early, you move through your day with real purpose, you tick off the boxes. Fountain of Grace International, Pretoria North.",
  robots: 'index, follow',
  alternates: { canonical: "https://www.fountaingrace.org/devotional/why-do-i-feel-empty-even-when-i-get-everything-done" },
  openGraph: {
    title: "Why do I feel empty even when I get everything done?",
    description: "You wake early, you move through your day with real purpose, you tick off the boxes. Fountain of Grace International, Pretoria North.",
    type: 'article',
    images: [{ url: "https://www.fountaingrace.org/devotional-cards/why-do-i-feel-empty-even-when-i-get-everything-done.jpg", width: 1080, height: 1350, alt: "Why do I feel empty even when I get everything done? - Fountain of Grace International" }],
    url: "https://www.fountaingrace.org/devotional/why-do-i-feel-empty-even-when-i-get-everything-done",
  },
  twitter: { card: 'summary_large_image', title: "Why do I feel empty even when I get everything done?", description: "You wake early, you move through your day with real purpose, you tick off the boxes. Fountain of Grace International, Pretoria North.", images: ["https://www.fountaingrace.org/devotional-cards/why-do-i-feel-empty-even-when-i-get-everything-done.jpg"] },
}

const jsonLd = [{"@context": "https://schema.org", "@type": "Article", "headline": "Why do I feel empty even when I get everything done?", "description": "You wake early, you move through your day with real purpose, you tick off the boxes. Fountain of Grace International, Pretoria North.", "image": "https://www.fountaingrace.org/devotional-cards/why-do-i-feel-empty-even-when-i-get-everything-done.jpg", "author": {"@type": "Person", "name": "Pastor Ricardo Zaal"}, "publisher": {"@type": "Church", "name": "Fountain of Grace International", "address": {"@type": "PostalAddress", "streetAddress": "323 B Danie Theron Street", "addressLocality": "Pretoria North", "addressRegion": "Gauteng", "addressCountry": "ZA"}}, "datePublished": "2026-07-01T06:00:00+02:00", "dateModified": "2026-07-01T06:00:00+02:00", "mainEntityOfPage": "https://www.fountaingrace.org/devotional/why-do-i-feel-empty-even-when-i-get-everything-done", "url": "https://www.fountaingrace.org/devotional/why-do-i-feel-empty-even-when-i-get-everything-done", "isPartOf": {"@type": "CreativeWorkSeries", "name": "FGI Daily Devotional", "url": "https://www.fountaingrace.org/devotional"}}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.fountaingrace.org"}, {"@type": "ListItem", "position": 2, "name": "Daily Devotional", "item": "https://www.fountaingrace.org/devotional"}, {"@type": "ListItem", "position": 3, "name": "Why do I feel empty even when I get everything done?", "item": "https://www.fountaingrace.org/devotional/why-do-i-feel-empty-even-when-i-get-everything-done"}]}]
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <img
              src="https://www.fountaingrace.org/devotional-cards/w680/why-do-i-feel-empty-even-when-i-get-everything-done.webp"
              alt="Why do I feel empty even when I get everything done? - Fountain of Grace International"
              width={680}
              height={850}
              loading="eager"
              fetchPriority="high"
        ...
        <section className="bg-white py-10 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href="https://wa.me/?text=I%20thought%20this%20may%20encourage%20you%3A%20https%3A%2F%2Fwww.fountaingrace.org%2Fdevotional%2Fwhy-do-i-feel-empty-even-when-i-get-everything-done%3Futm_source%3Dwhatsapp%26utm_medium%3Dshare%26utm_campaign%3Ddevotional" target="_blank" rel="noopener noreferrer"
