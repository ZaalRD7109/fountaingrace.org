      ...
      <article>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/60 text-sm mt-4">Pretoria North · 4 July 2026</p>
          </div>
        </header>
        ...
        <section className="bg-white py-10 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <blockquote className="border-l-4 border-[#FFD600] pl-5 py-3 my-8 bg-[#f0fafa] rounded-r-xl">
              <p className="text-[#2a9df4] font-semibold text-lg italic leading-relaxed">&quot;{"But Jesus said, Suffer little children, and forbid them not, to come unto me: for of such is the kingdom of heaven."}&quot;</p>
