      ...
      <article>
        ...
        <section className="bg-white py-10 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-[#555] leading-relaxed text-lg">{"What would it feel like to stop hiding your exhaustion from God and just tell Him the truth today?"}</p>
        ...
        <section className="bg-white py-10 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-2xl mx-auto">
            ...
            <li>
              <Link href="/devotional/why-does-it-feel-like-god-has-forgotten-about-me" className="block py-2 text-[#0d6fbf] font-semibold underline leading-snug">{"Why does it feel like God has forgotten about me?"}</Link>
            </li>
            </ul>
          </div>
        </section>
