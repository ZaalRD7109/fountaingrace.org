      ...
      <article>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/60 text-sm mt-4">Pretoria North · 11 July 2026</p>
          </div>
        </header>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <img
              src="https://www.fountaingrace.org/devotional-cards/can-you-really-be-joyful-when-nothing-has-changed-yet.jpg"
