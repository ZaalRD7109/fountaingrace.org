...
export const metadata: Metadata = {
  title: "What if I start something but can't keep it going?",
  description: "You're not afraid of the starting line. You're terrified of what happens after you cross it. Fountain of Grace International, Pretoria North.",
  robots: 'index, follow',
  alternates: { canonical: "https://www.fountaingrace.org/devotional/what-if-i-start-something-but-cant-keep-it-going" },
  openGraph: {
    title: "What if I start something but can't keep it going?",
    description: "You're not afraid of the starting line. You're terrified of what happens after you cross it. Fountain of Grace International, Pretoria North.",
    type: 'article',
    images: [{ url: "https://www.fountaingrace.org/devotional-cards/what-if-i-start-something-but-cant-keep-it-going.jpg", width: 1080, height: 1350, alt: "What if I start something but can't keep it going? - Fountain of Grace International" }],
    url: "https://www.fountaingrace.org/devotional/what-if-i-start-something-but-cant-keep-it-going",
  },
  twitter: { card: 'summary_large_image', title: "What if I start something but can't keep it going?", description: "You're not afraid of the starting line. You're terrified of what happens after you cross it. Fountain of Grace International, Pretoria North.", images: ["https://www.fountaingrace.org/devotional-cards/what-if-i-start-something-but-cant-keep-it-going.jpg"] },
}

const jsonLd = [{"@context": "https://schema.org", "@type": "Article", "headline": "What if I start something but can't keep it going?", "description": "You're not afraid of the starting line. You're terrified of what happens after you cross it. Fountain of Grace International, Pretoria North.", "image": "https://www.fountaingrace.org/devotional-cards/what-if-i-start-something-but-cant-keep-it-going.jpg", "author": {"@type": "Person", "name": "Pastor Ricardo Zaal"}, "publisher": {"@type": "Church", "name": "Fountain of Grace International", "address": {"@type": "PostalAddress", "streetAddress": "323 B Danie Theron Street", "addressLocality": "Pretoria North", "addressRegion": "Gauteng", "addressCountry": "ZA"}}, "datePublished": "2026-06-06T06:00:00+02:00", "dateModified": "2026-06-06T06:00:00+02:00", "mainEntityOfPage": "https://www.fountaingrace.org/devotional/what-if-i-start-something-but-cant-keep-it-going", "url": "https://www.fountaingrace.org/devotional/what-if-i-start-something-but-cant-keep-it-going", "isPartOf": {"@type": "CreativeWorkSeries", "name": "FGI Daily Devotional", "url": "https://www.fountaingrace.org/devotional"}}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.fountaingrace.org"}, {"@type": "ListItem", "position": 2, "name": "Daily Devotional", "item": "https://www.fountaingrace.org/devotional"}, {"@type": "ListItem", "position": 3, "name": "What if I start something but can't keep it going?", "item": "https://www.fountaingrace.org/devotional/what-if-i-start-something-but-cant-keep-it-going"}]}]
    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <img
              src="https://www.fountaingrace.org/devotional-cards/w680/what-if-i-start-something-but-cant-keep-it-going.webp"
              alt="What if I start something but can't keep it going? - Fountain of Grace International"
              width={680}
              height={850}
              loading="eager"
              fetchPriority="high"
        ...
        <section className="bg-white py-10 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href="https://wa.me/?text=I%20thought%20this%20may%20encourage%20you%3A%20https%3A%2F%2Fwww.fountaingrace.org%2Fdevotional%2Fwhat-if-i-start-something-but-cant-keep-it-going%3Futm_source%3Dwhatsapp%26utm_medium%3Dshare%26utm_campaign%3Ddevotional" target="_blank" rel="noopener noreferrer"
