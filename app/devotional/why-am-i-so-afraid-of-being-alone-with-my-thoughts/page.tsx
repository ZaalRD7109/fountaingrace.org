    ...
    <>
      ...
      <article>
        ...
        <section className="bg-white pt-10 pb-2 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <img
              src="https://www.fountaingrace.org/devotional-cards/w680/why-am-i-so-afraid-of-being-alone-with-my-thoughts.webp"
        ...
        <section className="bg-white py-10 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-2xl mx-auto">
            ...
            <li>
              <Link href="/devotional/is-staying-in-a-painful-relationship-really-love-or-just-fear" className="block py-2 text-[#0d6fbf] font-semibold underline leading-snug">{"Is staying in a painful relationship really love or just fear?"}</Link>
            </li>
            <li>
